#
#  Be sure to run `pod spec lint DrApp.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "David Richards" => "dpricha189@gmail.com" }
  # Or just: s.author    = "David Richards"
  # s.authors            = { "David Richards" => "dpricha189@gmail.com" }
  # s.social_media_url   = "http://twitter.com/David Richards"
 ...
 #
  ...
  s.dependency "ChameleonFramework", "= 2.1.0"
end
